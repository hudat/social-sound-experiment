...
module.exports = function(tweet) {
  ...
  for(var i = 0; i < tweetWords.length; ++i) {
      ...
      if (_.contains(sadList, word)) { return 'sad'; }
      if (_.contains(happyList, word)) { return 'happy'; }
      if (_.contains(afraidList, word)) { return 'afraid'; }
      if (_.contains(angryList, word)) { return 'angry'; }
  };
  return null;
};
